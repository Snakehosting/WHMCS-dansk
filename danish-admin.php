...
$_ADMINLANG['global']['previouspage'] = "&laquo; Forrige side";
$_ADMINLANG['global']['nextpage'] = "Næste Side &raquo;";
...
$_ADMINLANG['sendmessage']['marketingemaildesc'] = "Remember to include the marketing unsubscribe link using {\$unsubscribe_url} to be compliant with the CAN-SPAM Act";
...
$_ADMINLANG['configservers']['serverdetails'] = "Server Detaljer";
$_ADMINLANG['configservers']['primarynameserver'] = "Primær Navneserver";
$_ADMINLANG['configservers']['secondarynameserver'] = "Sekundær Navneserver";
$_ADMINLANG['configservers']['thirdnameserver'] = "Tredje Navneserver";
$_ADMINLANG['configservers']['fourthnameserver'] = "Fjerde Navneserver";
$_ADMINLANG['configservers']['fifthnameserver'] = "Femte Navneserver";
$_ADMINLANG['configservers']['nameservers'] = "Navneservere";
$_ADMINLANG['configservers']['newgroup'] = "Opret ny gruppe";
$_ADMINLANG['configservers']['editgroup'] = "Rediger gruppe";
$_ADMINLANG['configservers']['addleast'] = "Føj til den mindst fulde server";
$_ADMINLANG['configservers']['fillactive'] = "Fyld aktiv server indtil fuld derefter skift til næst mindst anvendte";
$_ADMINLANG['configservers']['accesshashdesc'] = "(I stedet for password<br>til cPanel servere)";
$_ADMINLANG['configservers']['disableserver'] = "Afkryds for at deaktivere denne server";
$_ADMINLANG['configservers']['monthlycost'] = "Månedlige Omkostninger";
$_ADMINLANG['configservers']['assignedips'] = "Tildelte IP-adresser";
$_ADMINLANG['configservers']['assignedipsdesc'] = "(En pr linje)";
$_ADMINLANG['configservers']['datacenter'] = "Datacenter/NOC";
$_ADMINLANG['configservers']['maxaccounts'] = "Maksimal Antal konti";
$_ADMINLANG['configservers']['statusaddress'] = "Server Status Adresse";
$_ADMINLANG['configservers']['statusaddressdesc'] = "For at vise denne server på server status siden, skal du indtaste den fulde sti til serveren status mappe (forpligtet til at blive uploadet til hver server, du ønsker at overvåge) - eg. http://www.whmcs.com/status/";
$_ADMINLANG['configservers']['addserver'] = "Tilføj server";
$_ADMINLANG['configservers']['editserver'] = "Rediger server";
$_ADMINLANG['configservers']['groupname'] = "Gruppe Navn";
$_ADMINLANG['configservers']['servername'] = "Server Navn";
$_ADMINLANG['configservers']['activeaccounts'] = "Aktive konti";
$_ADMINLANG['configservers']['usage'] = "% Brug";
$_ADMINLANG['configservers']['disableserver'] = "Deaktiver Server";
$_ADMINLANG['configservers']['enableserver'] = "Aktiver server";
$_ADMINLANG['configservers']['addnewserver'] = "Tilføj ny server";
$_ADMINLANG['configservers']['createnewgroup'] = "Opret ny gruppe";
$_ADMINLANG['configservers']['pagedesc'] = "Det er her du konfigurere alle dine servere, så WHMCS kan kommunikere med dem. Standard server for hvert modul er markeret med en stjerne *. Du skal vælge en standard-server til automatisk setup til at fungere rigtigt.";
$_ADMINLANG['configservers']['delgroupconfirm'] = "Er du sikker på du ønsker at slette denne server gruppe?";
$_ADMINLANG['configservers']['delserverconfirm'] = "Er du sikker på du ønsker at slette denne server?";
$_ADMINLANG['configservers']['addedsuccessful'] = "Server succesfuldt tilføjet!";
$_ADMINLANG['configservers']['addedsuccessfuldesc'] = "Den nye server er blevet tilføjet, og er nu klar til brug.";
$_ADMINLANG['configservers']['delsuccessful'] = "Server slettet!";
$_ADMINLANG['configservers']['delsuccessfuldesc'] = "Den valgte server er nu blevet slettet.";
$_ADMINLANG['configservers']['groupdelsuccessful'] = "Server Gruppe slettet!";
$_ADMINLANG['configservers']['groupdelsuccessfuldesc'] = "Den valgte server-gruppen er nu slettet.";
$_ADMINLANG['configservers']['changesuccess'] = "Ændringerne blev gemt!";
$_ADMINLANG['configservers']['changesuccessdesc'] = "De ændringer, du har foretaget til serveren er blevet gemt.";
$_ADMINLANG['configservers']['errordesc'] = "Du kan ikke slette en server, mens hosting konti stadig er tildelt til det";
$_ADMINLANG['configservers']['error'] = "En fejl opstod";
$_ADMINLANG['configservers']['enabled'] = "Aktiveret server";
$_ADMINLANG['configservers']['enableddesc'] = "Den valgte server lykkedes genaktiveret";
$_ADMINLANG['configservers']['disabled'] = "Deaktivere Server";
$_ADMINLANG['configservers']['disableddesc'] = "Den valgte server lykkedes deaktiveret";
...
$_ADMINLANG['twofa']['activationerror'] = "Der opstod en fejl under aktivering af 2FA. Prøv igen.";
$_ADMINLANG['twofa']['generalerror'] = "Der opstod en fejl under indlæsning af modulet. Prøv venligst igen.";
$_ADMINLANG['twofa']['activationcomplete'] = $_ADMINLANG['twofa']['title']." Installationen er fuldført!";
